...
struct file_info {
  ...
  unsigned long long  m_flags;	/* more general flags (64-bit for NO_INCLUDES) */
...
struct list {
 ...
 #define NO_INCLUDES		0x100000000ULL  /* disable I directive for web safety */
 #define JSON_OUT		0x200000000ULL  /* emit layout JSON instead of PS */
 #define WORKER_MODE		0x400000000ULL  /* long-lived NDJSON worker (-worker flag) */

/* Worker mode error types and globals — see worker_types.h */
